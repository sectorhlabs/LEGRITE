...
extends JPanel {
    ...
    public Local4Panel(Map<String, List<String>> maquinasData, String directorioTrabajo) {
        ...
        JLabel tituloLocal = new JLabel("DATOS DEL LOCAL 4");
    ...
    public Map<String, String> getFormData() {
        ...
        formData.put("NLC_4", this.nombreLocalField.getText());
        formData.put("MRAA_4", (String)this.comboMaquinas.getSelectedItem());
        formData.put("MAA1_4", (String)this.comboModelos.getSelectedItem());
        for (int i = 0; i < this.labelsAtributos.length; ++i) {
            formData.put("MAA" + (i + 2) + "_4", this.fieldsAtributos[i].getText());
        }
        return formData;
    }
}
