...
extends JPanel {
    ...
    public Local2Panel(Map<String, List<String>> maquinasData, String directorioTrabajo) {
        ...
        JLabel tituloLocal = new JLabel("DATOS DEL LOCAL 2");
    ...
    public Map<String, String> getFormData() {
        ...
        formData.put("NLC_2", this.nombreLocalField.getText());
        formData.put("MRAA_2", (String)this.comboMaquinas.getSelectedItem());
        formData.put("MAA1_2", (String)this.comboModelos.getSelectedItem());
        for (int i = 0; i < this.labelsAtributos.length; ++i) {
            formData.put("MAA" + (i + 2) + "_2", this.fieldsAtributos[i].getText());
        }
        return formData;
    }
}
